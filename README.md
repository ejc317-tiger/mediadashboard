...
Settings includes an **Initial research run** that runs five exhaustive jobs for the last ten years of funded AI startups, AI-focused data-center facilities, currently active SPACs, qualifying US TMT venture firms and active portfolios, and TMT private-equity firms and active portfolios. Each job has its own report and confirmation step. Data-center results include facility coordinates, region, ownership, power, tenant, financing, and status fields so confirmed records populate the map. Investor records support AUM, active portfolio size, and publicly disclosed key contacts; company records support descriptions, latest round dates, round sizes, valuations, and investor relationships.
